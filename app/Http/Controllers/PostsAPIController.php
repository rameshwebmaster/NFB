...
//            unset($category->translations);
        ...
        $post->addTranslationItem('post_title', ($post->trans('post_title') !== null) ? $post->trans('post_title') : ""); //$post->addTranslationItem('post_title', $post->trans('post_title') ?? "");
        $post->addTranslationItem('post_body', ($post->trans('post_body') !== null) ? $post->trans('post_body') : ""); //$post->addTranslationItem('post_body', $post->trans('post_body') ?? "");
        $post->addTranslationItem('post_excerpt', ($post->trans('post_excerpt') !== null) ? $post->trans('post_excerpt') : ""); //$post->addTranslationItem('post_excerpt', $post->trans('post_excerpt') ?? "");
